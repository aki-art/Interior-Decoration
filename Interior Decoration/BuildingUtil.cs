...
namespace InteriorDecoration
{
    class BuildingUtil
    {
        ...
        public static void RegisterAllBuildings(List<IDBuilding> buildings)
        {
            foreach(IDBuilding building in buildings)
            {
        ...
        public struct IDBuilding
        {
            public string id;
            public Type type;

            public IDBuilding(string id, Type type)
            {
                this.id = id;
                this.type = type;
            }
