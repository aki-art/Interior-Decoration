...
namespace InteriorDecoration.Buildings.StainedGlassTiles
{
    ...
    [BuildMenu("Base")]
    public class RustStainedGlassTileConfig : IBuildingConfig
    {
        public static readonly int BlockTileConnectorID = Hash.SDBMLower("tiles_glass_tops");
        public const string ID = Mod.MOD_PREFIX + "RustStainedGlassTile";

        public override BuildingDef CreateBuildingDef()
        {
            return TileHelper.CreateTileBuildingDef(ID, "Rust");
        }
